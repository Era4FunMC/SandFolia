...
tasks.generateDevelopmentBundle {
    apiCoordinates.set("org.era4funmc.sandfolia:sandfolia-api")
...
paperweight {
    serverProject.set(project(":sandfolia-server"))
    ...
    useStandardUpstream("folia") {
        ...
        withStandardPatcher {
            ...
            apiOutputDir.set(layout.projectDirectory.dir("SandFolia-API"))

            serverPatchDir.set(layout.projectDirectory.dir("patches/server"))
            serverOutputDir.set(layout.projectDirectory.dir("SandFolia-Server"))
        }
    }
}
